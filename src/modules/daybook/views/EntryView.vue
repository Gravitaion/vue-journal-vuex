<template>
    <div class="entry-title d-flex justify-content-between p-2">
        <div>
            ...
            <span class="mx-2 fs4 fw-light">2021, jueves</span>
        </div>
        <div>
    ...
    <Fab icon="fa-save" />
    <img src="https://dlprivateserver.com/wp-content/uploads/2022/02/1643692675_Pokemon-Legends-Arceus-Como-evolucionar-a-Gligar-a-Gliscor.jpg"
        alt="entry-picture"
        class="img-thumbnail">
</template>
